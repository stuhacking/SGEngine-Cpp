 ...
 */
std::string padLeft (const std::string &str, const int width,
                     const char c = ' ');
 ...
 * @param c Char to use for padding
 */
std::string padRight (const std::string &str, const int width,
                      const char c = ' ');
 ...
 * @param c Char to use for padding
 */
std::string padCenter (const std::string &str, const int width,
                       const char c = ' ');
