...
public:
    ...
    const Vector4 &operator[] (const u32 index) const;

    Vector4 &operator[] (const u32 index);
...
inline const Vector4 &Matrix4::operator[] (const u32 index) const {
    return mat[index];
}

inline Vector4 &Matrix4::operator[] (const u32 index) {
    return mat[index];
}
