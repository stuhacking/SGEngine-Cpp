...
TEST (math_Test, ClampFloat) {
    EXPECT_EQ(4.0f, math::clampFloat(4.0f, 0.0f, 10.0f));
    EXPECT_EQ(4.0f, math::clampFloat(2.0f, 4.0f, 10.0f));
    EXPECT_EQ(8.0f, math::clampFloat(12.0f, 0.0f, 8.0f));
}

TEST (math_Test, ClampInt) {
    EXPECT_EQ(4, math::clampInt(4, 0, 10));
    EXPECT_EQ(4, math::clampInt(2, 4, 10));
    EXPECT_EQ(8, math::clampInt(12, 0, 8));
}
...
TEST (math_Test, ClampedRatio) {
    EXPECT_EQ(0.5f, math::clampedRatio(5.0f, 0.0f, 10.0f));
    EXPECT_EQ(1.0f, math::clampedRatio(12.0f, 10.0f, 11.0f));
}
